...
public class CalculatorTest {
	...
	public void testAdditionOneNegativeNumber() {
		assertThrows(IllegalArgumentException.class, () -> calculator.add(Integer.valueOf(-10), Integer.valueOf(12)));
	...
	@Test()
	@DisplayName(" Test addition suceess when one   argument is zero")
	public void testAdditionOneNumberisZero() {
		Mockito.when(adder.add(Mockito.anyInt(), Mockito.anyInt())).thenReturn(12);
		Integer result = calculator.add(Integer.valueOf(0), Integer.valueOf(12));
		assertEquals(Integer.valueOf(12), result);
	}
	
	@Test()
	@DisplayName(" Test addition suceess when one   argument is zero")
	public void testAdditionOneNumberZero() {
		Mockito.when(adder.add(Mockito.anyInt(), Mockito.anyInt())).thenReturn(12);
		Integer result = calculator.add(Integer.valueOf(12), Integer.valueOf(0));
		assertEquals(Integer.valueOf(12), result);
	}
